...
function SheetHeader({ className, children, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('flex flex-row items-center justify-between gap-2 border-b border-border h-14 -mt-6 pl-9 shrink-0 bg-background sticky -top-6 z-20', className)}
      {...props}
    >
